...
class CubeState:
    ...
    COLOR_NAMES = { 0 : "RED", 1 : "WHITE", 2 : "BLUE", 3 : "GREEN", 4 : "YELLOW", 5 : "ORANGE"}
    HEX_COLOR = ['#ff0000', '#ffffff', '#0000ff', '#00ff00', "#FFF700", "#ff7700"] # For matplot3d rendering
    
    def __init__(self):
        """ Intiialize solved cube with 8 bit int for memory efficiency """
        # U = 0:8 , R = 9:17, F = 18:26, D = 27:35, L = 36:44, B = 45:53
        self.state = np.array([i for i in range(6) for _ in range(9)], dtype=np.int8)
    ...
    def get_faces(self) -> Dict[str, np.ndarray]:
        ...
        # Returns a dict of of 6 3x3 arrays
        return {
